...
public class VisibleButton extends Component {
    ...
    public void renderComponent() {
        ...
        Access.getInstance().getFontManager().F18.drawStringWithShadow("Visible: " + Access.getInstance().getModuleManager().isVisible(mod), (parent.parent.getX() + 7) , (parent.parent.getY() + offset + 2)  +1, -1);
        GL11.glPopMatrix();
    }
